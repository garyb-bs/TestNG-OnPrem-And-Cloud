...
public class DriverManager {
    ...
    public void setUp(String config_file, String environment) throws Exception {
        ...
        if (config_file.equals("onprem")) {
            driver = new ChromeDriver();
        } else {
            setUpBrowserStackDriver(config_file, environment);
        }
    }
    ...
    private void setUpBrowserStackDriver(String config_file, String environment) throws Exception {
        ...
        Map<String, String> envCapabilities = (HashMap<String, String>) envs.get(environment);
